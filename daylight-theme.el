;;; daylight-theme.el --- Easy on the eyes  -*- lexical-binding: t; -*-
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(completions-common-part ((,class (:weight bold :underline t))))
   `(orderless-match-face-0 ((,class (:weight bold :underline t))))
   `(orderless-match-face-1 ((,class (:weight bold :underline t))))
   `(orderless-match-face-2 ((,class (:weight bold :underline t))))
   `(orderless-match-face-3 ((,class (:weight bold :underline t))))

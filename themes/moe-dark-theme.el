...
(let ((class '((class color) (min-colors 89)))
      ...
      (black-2-5 "#6c6c6c") (black-3 "#4e4e4e") (black-4 "#3a3a3a") (black-5 "#303030") (black-5-5 "#0e0e0e")(black-6 "#000000")
  ...
  (custom-theme-set-faces
   ...
   ;; Highlighting faces
   `(fringe ((,class (:foreground ,black-1 :background unspecified))))
   ...
   `(mode-line-active ((,class (:box nil :background ,magenta-0 :foreground "#cc1fb8"))))
   `(mode-line-inactive ((,class (:box nil :background ,black-5-5 :foreground ,black-2))))
   `(mode-line-emphasis ((,class (:box nil :background ,orange-1 :foreground ,orange-5))))
   `(mode-line-highlight ((,class (:box nil :background ,green-1 :foreground ,green-5))))
   ;; `(mode-line-buffer-id ((,class (:box nil :foreground ,black-5 :background unspecified :bold t))))
   `(eglot-mode-line ((,class (:foreground ,black-6))))
   `(vertical-border ((,class (:foreground ,black-4 :background unspecified))))
   ...
   `(org-block-begin-line ((,class (:foreground ,white-0 :height 0.5 :background ,blue-3))))
   `(org-block-end-line ((,class (:foreground ,black-3 :height 0.5 :background ,black-4))))
   `(org-checkbox ((,class (:height 2.0 :weight bold))))
   ...
   `(org-done ((,class (:bold t :weight bold :foreground ,green-4 :background ,green-0 :box (:line-width 1 :style nil)))))
   `(org-ellipsis ((,class (:foreground ,moe-dark-bg :background ,orange-1))))
   `(org-footnote ((,class (:foreground ,magenta-3))))
   `(org-formula ((,class (:foreground ,purple-2))))
   `(org-headline-done ((,class (:foreground ,green-2))))
   `(org-hide ((,class (:foreground ,black-6))))
   `(org-level-1 ((,class (:height 2.00 :foreground ,blue-1))))
   `(org-level-2 ((,class (:height 1.50 :foreground ,green-2))))
   `(org-level-3 ((,class (:height 1.17 :foreground ,orange-2))))
   `(org-level-4 ((,class (:height 1.00 :foreground ,cyan-3))))
   `(org-level-5 ((,class (:height 0.83 :foreground ,red-1))))
   `(org-level-6 ((,class (:height 0.67 :foreground ,purple-2))))
   `(org-level-7 ((,class (:height 0.52 :foreground ,magenta-2))))
   `(org-level-8 ((,class (:height 0.43 :foreground ,yellow-2))))
   ...
   ;; org-modern
   ;; `(org-modern-todo ((,class (:foreground ,red-3 :background ,red-3))))
   ...
   `(eshell-prompt ((,class (:foreground ,green-2 :bold t))))
   ...
   ;; `(flymake-warning-echo ((,class (:foreground ,orange-2))))
   `(flymake-errline ((,class (:underline ,red-2))))
   `(flymake-error-echo ((,class (:foreground ,red-2))))
   ;; `(flymake-noteline ((,class (:underline ,red-2))))
   ...
   `(compilation-error ((,class (:foreground ,red-3 :background unspecified :bold t))))
   `(compilation-info ((,class (:foreground ,orange-2 :background unspecified))))

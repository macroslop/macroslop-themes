...
(custom-set-faces
 '(default ((t :background "#000000" :foreground "#ffffff")) t)
 '(mode-line ((t :background "#2c2c2c")) t)
 '(mode-line-inactive ((t :background "#1e1e1e" :foreground "#3f3f3f")) t)
 '(vertical-border ((t :foreground "#1e1e1e")) t)
 '(region ((t :background "#3f3f3f")) t)
 '(font-lock-comment-face ((t :foreground "#3f3f3f")) t)
 '(hl-line ((t :background "#1e1e1e")) t)
 '(vertico-current ((t :background "#1e1e1e")) t)
 '(flycheck-fringe-warn ((t :foreground "DarkOrange")) t)
 '(flycheck-fringe-info ((t :foreground "ForestGreen")) t)
 '(flycheck-fringe-error ((t :foreground "Red")) t))

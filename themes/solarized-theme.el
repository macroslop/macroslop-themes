;; solarized-theme.el  --- Precision colors for machines and people -*- lexical-binding: t; -*-
    ...
    (let ((bg-back   '(:background back))
      ...
      (mapcar (lambda (face) (apply 'create-face-spec face))
              `(;; basic
                ...
                ;; Flymake
                (flymake-errline (,@fmt-bold ,@fmt-curl-red)) ; Error
                (flymake-warnline (,@fmt-bold ,@fmt-curl-yellow))
                (flymake-end-of-line-diagnostics-face (:background nil))
                (flymake-error (,@fg-red :background nil))
                (flymake-error-echo (,@fg-red :background nil))
                (flymake-error-echo-at-eol (,@fg-red :background nil))
                (flymake-warning (,@fg-yellow :background nil))
                (flymake-warning-echo (,@fg-yellow :background nil))
                (flymake-warning-echo-at-eol (,@fg-yellow :background nil))
                (flymake-note (,@fg-violet :background nil))
                (flymake-note-echo (,@fg-violet :background nil))
                (flymake-note-echo-at-eol (,@fg-violet :background nil))
                ;; eglot
                (eglot-mode-line (:foreground nil))
                ;; column-marker

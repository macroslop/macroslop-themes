;;; reverse-theme.el --- Reverse theme for Emacs  -*- lexical-binding: t; -*-
...
(custom-theme-set-faces
 ...
 '(completions-annotations ((t (:foreground "grey70"))))
 ...
 '(mode-line ((t (:background "grey20" :foreground "#e3e3e3"))))
 '(mode-line-buffer-id ((t (:weight bold :foreground "orange"))))
 '(mode-line-inactive ((t (:background "grey10" :foreground "grey80"))))
 ...
 '(vertical-border ((t (:foreground "#1e1e1e"))))

...
(let ((class '((class color) (min-colors 89)))
      ...
      (mode-line-fg "White")
      (mode-line-bg "Grey")
      (mode-line-inactive-bg "DarkGrey")
      (region-bg "grey35"))
  ...
  (custom-theme-set-faces
   ...
   `(link ((,class (:foreground "LightBlue" :underline t))))

   ;; Modeline
   ;; `(mode-line ((,class (:foreground ,modeline-fg :background ,modeline-bg :box (:line-width -1 :style released-button)))))
   ;; `(mode-line-inactive ((,class (:foreground ,modeline-fg :background ,bg-grey :box (:line-width -1 :style released-button)))))
